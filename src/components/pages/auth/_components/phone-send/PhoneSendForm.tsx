    ...
    return (
        <form onSubmit={onSubmit} className="space-y-4">
            ...
            <div className={cn(
                ...
                <span className="text-[10px] font-bold text-slate-550 uppercase tracking-widest block mb-1">Send Amount (iUSD)</span>
                ...
                <span className="text-[9px] text-slate-555 block mt-1">Available: ${balanceUsdc}</span>
