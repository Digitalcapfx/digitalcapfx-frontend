...
const CtaSection = () => {
    ...
    return (
        <section id="cta">
            <div className="py-20 lg:py-24 max-w-7xl mx-auto">
                ...
                <div className="relative overflow-hidden bg-gradient-to-br from-[#080E21] to-[#12224A] border border-white/10 rounded-[32px] py-16 px-6 sm:px-12 text-center shadow-2xl">
                    ...
                    <div className="relative z-10 space-y-6 max-w-2xl mx-auto">
                        <span className="text-[10px] font-bold tracking-[0.25em] text-cyan-400 uppercase block font-mono">
                            {t('cta.badge', { defaultValue: 'Start Today' })}
                        </span>
                        ...
                        <p className="text-slate-300 text-sm sm:text-base leading-relaxed font-sans max-w-lg mx-auto">
                            {t('cta.subtitle', { defaultValue: 'Join 150,000+ users managing their money the smart way. Create your account in under 2 minutes.' })}
                        </p>
                        ...
                        <div className="pt-4 flex flex-col items-center space-y-4">
                            <Link href="/get-started">
                                ...
                                >
                                    {t('cta.button', { defaultValue: 'Create Business Account' })}
                                </Button>
                            </Link>
                            ...
                            <div className="flex items-center justify-center space-x-6 text-xs text-slate-500 select-none pt-2">
                                <div className="flex items-center">
                                    ...
                                    <span className="font-semibold text-slate-400 font-sans">{t('cta.noCard', { defaultValue: 'No credit card required' })}</span>
                                </div>
                                <div className="flex items-center">
                                    <Check className="h-3.5 w-3.5 text-emerald-400 stroke-[3] mr-1.5" />
                                    <span className="font-semibold text-slate-400 font-sans">{t('cta.cancelAnytime', { defaultValue: 'Cancel anytime' })}</span>
                                </div>
                            </div>
                        </div>
                    </div>
