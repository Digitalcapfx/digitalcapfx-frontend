...
const CheckIcon = () => (
    <div className="w-6 h-6 rounded-full bg-emerald-500/10 border border-emerald-500/25 flex items-center justify-center text-emerald-400 select-none">
        <Check className="h-3.5 w-3.5 stroke-[3]" />
    </div>
);

const XIcon = () => (
    <div className="w-6 h-6 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-600 select-none">
...
const ComparisonSection = () => {
    return (
        <section id="comparison" className="py-20 lg:py-28 text-center space-y-12">
